...
const seeds: Seed[] = [
  ...
  { id: "maximalist-collage", name: "Maximalist collage", suitability: ["music", "events", "youth brands"], accessibilityRisk: "high", compatibleWith: ["y2k", "playful"], antiPatterns: ["competing CTAs", "unreadable overlays"], axes: [5, 5, 5, 4, 5, 5, 4] },
  ...
  { id: "playful", name: "Playful", suitability: ["education", "family", "consumer"], accessibilityRisk: "medium", compatibleWith: ["bauhaus", "y2k"], antiPatterns: ["childish tone mismatch", "animation overload"], axes: [4, 4, 4, 3, 5, 4, 4] },
